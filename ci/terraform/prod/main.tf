...
module "s3" {
  ...
  js_brkcdn_name        = "js.brkcdn.com"
  css_brkcdn_name       = "css.brkcdn.com"
  downloads_brkcdn_name = "downloads.brkcdn.com"
}
