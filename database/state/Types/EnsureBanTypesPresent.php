...
class EnsureBanTypesPresent extends State
{
    ...
    protected array $rows = [
        ...
        ['id' => 3, 'name' => 'Uploading incorrect templates', 'default_note' => 'Use the BrickBit clothing template to create your shirts and pants.', 'default_length' => 0],
        ...
        ['id' => 18, 'name' => 'Purchasing/selling/trading items using third-party resources', 'default_note' => 'Do not purchase, sell or trade items on BrickBit using third-party resources or methods outside those provided to you.', 'default_length' => 37317600],
        ...
        ['id' => 27, 'name' => 'Discussing inappropriate topics', 'default_note' => 'Do not discuss topics that are sexual, discriminatory or otherwise inappropriate on BrickBit.', 'default_length' => 0],
