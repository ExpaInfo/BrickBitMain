...
class EnsureForumBoardsPresent extends State
{
    ...
    protected array $rows = [
        ['id' => 1, 'name' => 'BrickBit Hub', 'description' => 'Talk about all things relating to BrickBit.', 'category_id' => 2, 'power' => 0],
        ...
        ['id' => 7, 'name' => 'Game Talk', 'description' => 'Discuss various video games unrelated to BrickBit.', 'category_id' => 3, 'power' => 0],
