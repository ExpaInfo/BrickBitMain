...
<div class="col-10-12 push-1-12">
    ...
    <div class="card">
        ...
        <div class="content">
            ...
            <span class="dark-gray-text" style="font-size:16px;">Please make sure that you have read our <a class="darker-gray-text bold" href="/terms" target="_blank">Terms of Service</a> before returning to make sure you and others have the best experience on BrickBit.</span>
            <hr>
            <div style="margin-bottom:10px;">
